# -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 15:07:17 2021
...
def build_char_vectors(swarms=3,clusters=8): # 3 swarms 8 clusters
...
# tau_s2 = 1,2
# T_s = 180, 220, 260
def geo_optim_solve(T_s, swarm_no, cluster_no, tau_s1=1,tau_s2=1,theta=0.8):#, \
        #run_index=None):
    ...
    # calc initial point
    # install a shift
    plot_acc = np.roll(plot_acc,1) #deepcopy(plot_acc[0])
    ...
    worker_freq[i] = [kk.value for kk in worker_freq[i]]
...
if __name__ == '__main__':
    ...
    # %% plotting
    # rng_result_energy = 61.27
    # rng_result_grad = 5.532
    
    # %% plot 1 - varying iteration number vs objective/learning/gradient
